...
第一位不匹配时,子串后移一位：  
![](./images/第一位不匹配.png"></div>  
![](./images/1子串后移.png"></div>  

>即子串1号位与主串下一位比较

第二位不匹配时,子串后移一位：  
![](./images/第二位不匹配.png"></div>  
![](./images/2子串后移.png"></div>  

>即子串1号位与主串当前位比较  

第四位不匹配时,子串后移二位：  
![](./images/第四位不匹配.png"></div>  
![](./images/4子串后移.png"></div>  

>即子串2号位与主串当前位比较  

第五位不匹配时,子串后移二位：  
![](./images/第五位不匹配.png"></div>  
![](./images/5子串后移.png"></div>  

>即子串3号位与主串当前位比较  

第六位不匹配时,子串后移二位：  
![](./images/第六位不匹配.png"></div>  
![](./images/6子串后移.png"></div>  
