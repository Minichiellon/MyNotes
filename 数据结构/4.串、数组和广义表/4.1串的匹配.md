...
3是怎么来的呢？ $\color{red}子串中匹配成功的部分中无重复元素的最长子串$ 。  
...
而 $j$ 需要回溯，但却不必回溯到 1 。具体回溯到哪里，和匹配失败的位置有关。事实上，应该是和子串本身的结构有关。  
...
<table>
  <tbody>
    <tr>
      <td>T [ j ]</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td>
    </tr>
    <tr>
      <td>T =</td><td>A</td><td>B</td><td>C</td><td>A</td><td>C</td>
    </tr>
    <tr>
      <td>next[j]</td><td>1</td><td>1</td><td>1</td><td>1</td><td>2</td>
    </tr>
  </tbody>
</table>
