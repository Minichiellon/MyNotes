...
- 读写FLASH会中断CPU的执行
# 2.内存模块组织
![](./images/15.1-内存模块组织.png"></div>

# 3.FLASH基本结构
![](./images/15.1-FLASH基本结构.png"></div>
...
# 5.2.程序存储器全擦除
![](./images/15.1-程序存储器全擦除.png"></div>

# 5.3.程序存储器页擦除
![](./images/15.1-程序存储器页擦除.png"></div>

# 5.4.程序存储器编程
![](./images/15.1-程序存储器编程.png"></div>  
