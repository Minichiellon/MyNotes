...
# 1.数据包通信
**HEX数据包**
<div><img src = "./images/7.3-HEX数据包.png"></div>

**文本数据包**
<div><img src = "./images/7.3-文本数据包.png"></div>

**HEX数据包接收**
<div><img src = "./images/7.3-HEX数据包接收.png"></div>

**文本数据包接收**
<div><img src = "./images/7.3-文本数据包接收.png"></div>
