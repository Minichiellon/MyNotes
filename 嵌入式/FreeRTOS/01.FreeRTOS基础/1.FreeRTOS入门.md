...
对于RTOS系统，可以创建两个任务，然后 <span style="color:red">以很短的时间间隔交替执行</span> 两个任务，使得 $\color{red}{看起来两个任务在同时执行}$ 。  

<span style="background-color:red; color:white; padding:2px 6px">错误</span>
